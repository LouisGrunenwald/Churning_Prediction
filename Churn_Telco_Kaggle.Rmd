...
library("factoextra")
library("xgboost")
setwd("D:/Documents/Cours M2 MoSEF/DATA MINING/Projet 2019 Telco")
```
...
#navarspl
tab.kNN=kNN(table[,-21], k=7, imp_var=F)#peut etre long k=5 est le nombre de voisin qu il va regarder pour calculer la dist
#nume.kNN
summary(tab.kNN)
